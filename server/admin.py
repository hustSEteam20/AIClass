...
admin.site.register(models.CourseSelection)
...
#             return models.CourseDetail.objects.filter(Q(stu_id='M20180001'), Q(interaction=1))
#         if(self.value()) == 'M20180002':
#             return models.CourseDetail.objects.filter(Q(stu_id='M20180002'))
#
#
#
...
#
#
# @admin.register(models.CourseDetail)
